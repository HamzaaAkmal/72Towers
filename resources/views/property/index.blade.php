    ...
    <div class="col-xl-3 col-sm-6 cdx-xl-50">
        <div class="card blog-wrapper">
            <div class="imgwrapper">
                <img class="img-fluid property-img" src="{{asset(Storage::url('upload/thumbnail')).'/'.$thumbnail}}"
                    alt="{{$property->name}}">
                <a class="hover-link" href="{{route('property.show',$property->id)}}"><i data-feather="link"></i></a>
            </div>
            ...
            <div class="detailwrapper">
                ...
                <p class="text-justify">{{substr($property->description, 0,
                    200)}}{{!empty($property->description)?'...':''}}</p>

            ...
            @if ($invoice->status != 'paid')
                @can('create invoice payment')
                    ...
                    @else
                        ...
                        <a href="#" class="btn btn-warning float-end me-2 customModal" data-size="lg"
                            data-url="{{ route('invoice.reminder', $invoice->id) }}"
                        ...
                        <ul class="nav nav-tabs border-0 mb-15">
                            ...
                            @if (
                                ...
                                <li><a class="btn" data-bs-toggle="tab"
                                        href="#flutterwave_payment">{{ __('Flutterwave') }}</a>
                                </li>
                            @endif
                        </ul>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12 ">
                                                            <input type="button" value="{{ __('Pay Now') }}"
                                                                class="btn btn-primary" id="flutterwavePaymentBtn">
                                                        </div>
                            ...
                            <div class="invoice-user">
                                ...
                                <div class="right-user">
                                    <ul class="detail-list">
                                        ...
                                        <li>{{ __('Invoice No') }}: <span>{{ invoicePrefix() . $invoice->invoice_id }}
                                            </span>
                                        </li>
                                        <li>{{ __('Invoice Month') }}:
                                            <span> {{ date('F Y', strtotime($invoice->invoice_month)) }} </span>
                                        </li>
